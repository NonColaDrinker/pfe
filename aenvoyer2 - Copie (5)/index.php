  ...
  <body>
    ...
    <section class="hero">
        <div class="container">
            <div class="row">
                ...
                <!--image-->
                <div class="col-md-6">
                  <img src="assets/img/bricole-img.png" alt="hero-img" class="w-100">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cards">
        <div class="text-header text-center">
            <h3>Lancer-vous avec nos artisans</h3>
            ...
            <div class="col" >
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  echo "<p class=\"card-text\" maxlength=\"10\">".$cont."</p>";
                  ?>
